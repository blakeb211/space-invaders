...
term clang++ -std=c++17 -stdlib=libc++ -fuse-ld=lld -Lc:\SFML\lib -IC:\SFML\include -lsfml-graphics -lsfml-window -lsfml-system collision_manager.cpp voxel.cpp builder.cpp entity.cpp proto1.cpp -o game.exe
